  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-8 z-10 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          { title: "Plant a Tree", xp: 500, type: "Monthly Mission", icon: Leaf, bg: "bg-emerald-500" },
          { title: "Zero Plastic Day", xp: 100, type: "Daily Challenge", icon: Target, bg: "bg-blue-500" },
          { title: "Clean a Beach", xp: 1000, type: "Community Event", icon: Trophy, bg: "bg-amber-500" }
        ].map((c, i) => (
          <motion.div 
            key={i}
            whileHover={{ y: -4 }}
          ...
          >
            ...
            <button className="w-full mt-6 py-3 bg-white/5 hover:bg-emerald-500/20 hover:text-emerald-300 text-slate-300 rounded-xl font-medium transition-colors border border-white/10 hover:border-emerald-500/30">
              Accept Challenge
            </button>
          </motion.div>
        ))}
